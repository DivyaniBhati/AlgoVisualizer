      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-6">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          <div className="bg-gray-800 rounded-lg p-4 sm:p-6">
            ...
            <div className="bg-gray-950 rounded-md p-4 overflow-auto max-h-[450px] text-sm">
          ...
          <div className="bg-gray-800 rounded-lg p-4 sm:p-6">
            ...
            <div className="bg-gray-950 rounded-md p-4 mb-4 min-h-[250px] flex items-center justify-center">
              {renderGrid()}
            </div>
