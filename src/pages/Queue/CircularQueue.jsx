      ...
      <div className="bg-gray-800 p-4 rounded-lg shadow-xl border border-gray-700 mb-6 space-y-4">
        <div className="flex flex-col md:flex-row items-center gap-4">
          ...
          <input
            ...
            min="1"
            max="20"
            className="font-mono w-24 bg-gray-950 border border-gray-600 rounded-md p-2 focus:ring-2 focus:ring-pink-500"
          />
          ...
          <input
            ...
            className="font-mono flex-grow bg-gray-950 border border-gray-600 rounded-md p-2 focus:ring-2 focus:ring-pink-500"
          />
        </div>
