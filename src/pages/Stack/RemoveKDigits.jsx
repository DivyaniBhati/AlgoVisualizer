      ...
      <div className="bg-gray-800 p-4 rounded-lg shadow-xl border border-gray-700 flex flex-col md:flex-row items-center justify-between gap-4 mb-6">
        <div className="flex items-center gap-4 flex-grow">
          ...
          <input
            ...
            disabled={isLoaded}
            className="font-mono flex-grow bg-gray-950 border border-gray-600 rounded-md p-2 focus:ring-2 focus:ring-violet-500"
          />
          <label
            htmlFor="k-input"
            className="font-medium text-gray-300 font-mono"
          ...
          <input
            ...
            disabled={isLoaded}
            className="font-mono bg-gray-950 border border-gray-600 rounded-md p-2 w-20 focus:ring-2 focus:ring-violet-500"
          />
        </div>
