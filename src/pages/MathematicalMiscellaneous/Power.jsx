        ...
        <div className="flex flex-col md:flex-row gap-4 flex-grow">
          <div className="flex items-center gap-4 flex-grow">
            ...
            <input
              ...
              disabled={isLoaded}
              placeholder="e.g., 2"
              className="font-mono flex-grow bg-gray-950 border border-gray-600 rounded-lg p-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all disabled:opacity-50"
            />
          </div>
          <div className="flex items-center gap-4">
            ...
            <input
              ...
              disabled={isLoaded}
              placeholder="e.g., 10"
              className="font-mono bg-gray-950 border border-gray-600 rounded-lg p-3 w-20 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all disabled:opacity-50"
            />
          </div>
        </div>
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2">
                  ...
                  <select
                    ...
                    className="bg-gray-950 border border-gray-600 rounded-lg px-3 py-2 text-white text-sm cursor-pointer"
                  >
                ...
                <div className="font-mono px-4 py-2 bg-gray-950 border border-gray-600 rounded-lg text-center min-w-20">
